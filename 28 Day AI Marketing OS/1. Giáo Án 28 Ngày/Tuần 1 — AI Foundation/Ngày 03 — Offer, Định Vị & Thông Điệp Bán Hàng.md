...
> 🗂️ **Trong Vault SME (framework bàn giao `ai-marketing-system/`):** Chạy `/thiet-ke-offer` (Value Equation Hormozi có sẵn trong vault) — offer lưu `00. Business Context/Sản Phẩm & Dịch Vụ/`; Sales Message Pack lưu `04. Resources/Playbooks/`.

> Hôm nay bạn chuyển từ "tôi bán dịch vụ gì" sang "tôi giúp khách đạt kết quả gì — nhanh hơn, chắc hơn, ít rủi ro hơn": đóng gói một Offer (gói chào bán) đáng giá và bộ thông điệp bán hàng dùng cho mọi kênh trong 25 ngày còn lại.
...
- ⭐ **Landing Page Copy Draft (bản nháp nội dung trang đích)** — theo sườn StoryBrand 7 phần, dùng cho tuần 2.
...
[NHIỆM VỤ] Đề xuất 3 phương án offer cho sản phẩm chủ lực: (1) AN TOÀN — không thêm cam kết rủi ro, chỉ tăng giá trị bằng bonus và đóng gói lại; (2) CÂN BẰNG — thêm cam kết theo mốc đo được với điều kiện rõ; (3) TÁO BẠO — risk reversal mạnh (hoàn tiền/làm lại theo điều kiện). Mỗi phương án gồm: tên offer, lời hứa chính, 3 bonus (mỗi bonus ghi rõ giải quyết nỗi lo nào từ bản đồ tâm lý), cam kết, lý do mua ngay, phân tích 3 dòng "DN được gì – chịu rủi ro gì – phù hợp khi nào".

[DỮ LIỆU ĐẦU VÀO] Business Snapshot: {{dán}}. Sản phẩm chủ lực & giá: {{tên + giá + thành phần hiện tại}}. Customer Avatar: {{dán}}. Pain–Desire–Fear–Objection Map: {{dán}}. Giới hạn của tôi: {{VD: không thể hoàn tiền 100%, chỉ nhận tối đa X khách/tháng}}.
...
```
[VAI TRÒ] Bạn là chuyên gia đóng gói sản phẩm dịch vụ, viết tài liệu offer nội bộ mà chủ DN và nhân viên sale cùng dùng thống nhất.
...
[NHIỆM VỤ] (1) Viết 3 phiên bản Value Proposition theo công thức: "[Tên DN] giúp [avatar] đạt [kết quả] trong [thời gian] bằng [cơ chế riêng] mà không cần [điều khách sợ/ghét]" — 1 bản trang trọng, 1 bản đời thường, 1 bản ngắn ≤15 từ. (2) Rút ra 3 USP, mỗi USP kèm bằng chứng cụ thể tôi đang có (con số, quy trình, cam kết, thiết bị). (3) Bonus: lập Positioning Map — chọn 2 trục quan trọng nhất với khách (từ bản đồ tâm lý, VD: mức cam kết rõ ràng ↔ mơ hồ; cá nhân hóa ↔ đại trà), đặt tôi và các đối thủ lên 4 góc phần tư, chỉ ra vùng trống tôi nên chiếm.

[DỮ LIỆU ĐẦU VÀO] Core Offer Document: {{dán}}. Customer Avatar + PDFO Map: {{dán phần chính}}. 2-3 đối thủ gần nhất và điểm mạnh của họ: {{VD: Spa A to hơn, giá rẻ hơn 20%; Clinic B có bác sĩ da liễu}}.

[ĐỊNH DẠNG ĐẦU RA] Mục 1: 3 câu đánh số. Mục 2: bảng USP | Bằng chứng. Mục 3: mô tả map bằng bảng 4 góc + 3 dòng khuyến nghị định vị.
...
```
[VAI TRÒ] Bạn nhập vai chính xác người khách trong hồ sơ avatar dưới đây — một khách hàng ĐA NGHI, từng mất tiền vì lời hứa suông, đang so sánh 3 nơi trước khi quyết định.

[BỐI CẢNH] Tôi sắp công bố offer mới. Trước khi dùng thật, tôi cần bạn "tấn công" nó như khách thật sẽ làm.

[NHIỆM VỤ] Đọc offer dưới đây và phản hồi theo 3 vòng: (1) Ấn tượng 10 giây đầu — hiểu ngay không, tin không, cái gì gây nghi ngờ; (2) Đặt 7 câu hỏi khó nhất bạn sẽ hỏi trước khi xuống tiền (tập trung vào cam kết, điều kiện, chi phí ẩn); (3) Nêu 3 lý do bạn vẫn CHƯA mua dù offer nghe ổn, và điều gì sẽ khiến bạn đổi ý. Cuối cùng thoát vai, chấm offer theo 5 tiêu chí (rõ ràng / hấp dẫn / khác biệt / đáng tin / thúc đẩy hành động — mỗi tiêu chí 1-10) và đề xuất 3 chỉnh sửa cụ thể.

[DỮ LIỆU ĐẦU VÀO] Customer Avatar (vai của bạn): {{dán}}. Offer cần phản biện: {{dán Core Offer Document}}.

[ĐỊNH DẠNG ĐẦU RA] 3 vòng nhập vai (viết giọng khách, xưng "em/chị" tự nhiên) + phần thoát vai có bảng điểm 5 tiêu chí + 3 chỉnh sửa.
...
**SOP-03: Làm mới offer & thông điệp theo quý (hoặc khi ra dịch vụ mới)**
- **Khi nào:** Đầu mỗi quý; hoặc khi tỷ lệ chốt tư vấn giảm >20% so với quý trước; hoặc khi ra mắt dịch vụ mới.
- **Ai làm:** Chủ DN (60-90').
- **Input:** Core Offer hiện tại + số liệu quý (tỷ lệ chốt, objection ghi nhận mới từ SOP-02) + PDFO Map bản mới nhất.
- **Các bước:** (1) Chạy Prompt 5 phản biện offer hiện tại với avatar mới nhất; (2) Nếu điểm "đáng tin" hoặc "thúc đẩy hành động" <7 → chạy lại Prompt 1-2 điều chỉnh cam kết/bonus/lý do mua ngay; (3) Chạy Prompt 4 bổ sung 5 câu ads mới theo objection mới; (4) Cập nhật tài liệu `04. Offer & Sales Message` trong Knowledge Base và huấn luyện lại AI Business Brain (quy trình Ngày 06); (5) Thông báo cho nhân viên sale về thay đổi.
- **Output:** Offer phiên bản mới + Sales Message Pack bổ sung + Knowledge Base đồng bộ.
- **Tần suất:** 4 lần/năm + đột xuất.
...
**Q4: Tôi có 5-7 dịch vụ, phải làm offer cho tất cả à?**
→ Không. 28 ngày này xây hệ thống quanh 1 offer chủ lực. Các dịch vụ khác sẽ vào Knowledge Base (Ngày 04) để chatbot trả lời được, nhưng thông điệp chủ lực chỉ MỘT. Bán giỏi 1 thứ rồi mới nhân bản.

**Q5: AI viết hook nghe "quảng cáo" quá, không giống giọng tôi?**
...
- Ngày trước: [[Ngày 02 — Chân Dung Khách Hàng & Customer Journey]] · Ngày sau: [[Ngày 04 — Knowledge Base Cho Doanh Nghiệp]]
- Tài sản hôm nay được dùng lại ở:
	- **Core Offer Document** → tài liệu `04. Offer & Sales Message` trong Knowledge Base (Ngày 04), nguồn sự thật cho chatbot báo giá (Tuần 3), khung landing page (Tuần 2).
	- **Value Proposition** → lời chào của AI Business Brain (Ngày 06), mở đầu mọi bài content (Tuần 2), phần giới thiệu trong kịch bản tư vấn (Tuần 3).
	- **Sales Message Pack** → "kho đạn" cho lịch content 30 ngày (Tuần 2), mẫu quảng cáo (Tuần 2), tin nhắn follow-up (Tuần 4).
	- **Kết quả phản biện của Prompt 5** → bổ sung FAQ & Objection Database (Ngày 04) — các câu hỏi khó của "chị Mai ảo" chính là FAQ thật.
