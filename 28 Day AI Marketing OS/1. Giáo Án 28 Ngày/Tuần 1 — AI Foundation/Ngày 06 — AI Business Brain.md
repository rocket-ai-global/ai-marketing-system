...
week: 1
day: 6
core-output: "AI Business Brain v1 trên RocketAgent (KB + Master Instruction) · 2 Assistant (Sales + Marketing) · Test Case Report 6 tình huống · Improvement List"
---
...
> 🗂️ **Trong Vault SME (framework bàn giao `ai-marketing-system/`):** AI Business Brain = vault đã điền + `CLAUDE.md` + `AI-Sale-Assistant.md` — KHÔNG dựng bot mới. Nghiệm thu: hỏi Claude Code/Hermes 10 câu về DN, agent phải trả lời đúng từ vault. 5 Assistant cấu hình trên Hermes trỏ về `00. Business Context/`. **Business Brain chính là Jarvis v1**: Jarvis đã cài từ Ngày 0 (V0.6) nhưng "ngơ" vì vault trống — hôm nay là ngày nó TỈNH DẬY nhờ 5 ngày nạp não; test 10 câu ngay qua Telegram. Lộ trình Jarvis v0→v3: [[Hướng Dẫn Cài Đặt Hermes Agent & Siêu Trợ Lý Jarvis]].

> Hôm nay bạn lắp ráp mọi thứ đã xây 5 ngày qua — Knowledge Base + khối bối cảnh + Prompt Library — thành một "bộ não AI" chạy được trên RocketAgent: hiểu doanh nghiệp, trả lời đúng giá, giữ đúng giọng, biết điều được phép và không được phép nói. Đây là nền móng của mọi AI Agent ở tuần 2-4.
...
**Template 6.1 — AI Instruction Document.** 7 phần với ô điền + bản Sen Spa mẫu song song: (1) Danh tính (Bạn là trợ lý AI của [DN]...) | (2) Nhiệm vụ & thứ tự ưu tiên (mẫu: chính xác theo KB > an toàn/đúng luật > đúng giọng > dẫn khách đi tiếp) | (3) Nguồn sự thật (chỉ KB; thiếu thì nói "để em kiểm tra lại" + xin liên hệ; CẤM bịa số) | (4) Được phép (danh sách) | (5) Không được phép (danh sách ≥5 — có sẵn 4 điều cứng của chương trình: không chẩn đoán/hứa tuyệt đối, không tự tạo khuyến mãi, không nói xấu đối thủ, không lộ dữ liệu nội bộ + ô thêm điều đặc thù) | (6) Giọng (dán khối [GIỌNG]) | (7) Leo thang (bảng: tình huống → AI nói gì → chuyển ai → trong bao lâu).

**Template 6.2 — Test Case Report.** Bảng 6 hàng × 6 cột: # | Tình huống (câu hỏi nguyên văn) | Kỳ vọng đúng | Kết quả AI (tóm tắt + ảnh) | Chấm ✅/⚠️/❌ | Truy nguyên (thiếu dữ liệu/sai hành xử) & đã sửa gì. 6 tình huống chuẩn: hỏi giá · so sánh · chê đắt · hỏi kiến thức ngây ngô · nhờ viết content · nhờ phân tích số liệu. Dưới bảng: khối "Vòng 2" ghi các ca chạy lại.

**Template 6.3 — Improvement List.** Bảng 4 cột: # | Thiếu/lỗi gì (phát hiện từ test nào) | Bổ sung vào đâu (KB — file nào / Instruction — phần nào) | Ai làm, hạn nào. *Gộp luôn danh sách `_Cần bổ sung.md` từ Ngày 04 vào đây — một danh sách nợ duy nhất.*
