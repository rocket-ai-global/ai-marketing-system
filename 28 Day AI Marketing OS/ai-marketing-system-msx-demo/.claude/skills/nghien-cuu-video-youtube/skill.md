...
```bash
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "KEYWORD" [OPTIONS]
```
...
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "claude code"

# Tìm video AI agents, ít nhất 50K views, trong tuần
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "ai agents" --min-views 50000 --date week

# Sắp xếp theo breakout ratio
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "mcp server" --sort ratio

# Video tiếng Việt về AI
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "AI automation" --lang vi --min-views 5000

# Chỉ in ra terminal
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "vibe coding" --no-save
```
...
```bash
uv run .claude/skills/nghien-cuu-video-youtube/scripts/research_topic.py "KEYWORD" --min-views MIN --date DATE --sort SORT
```
