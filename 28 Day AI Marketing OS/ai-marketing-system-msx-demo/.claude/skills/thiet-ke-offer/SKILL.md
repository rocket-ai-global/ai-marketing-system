...
Trong vault này, ngữ cảnh sản phẩm/định vị nằm ở `00. Business Context/Chân Dung Doanh Nghiệp.md` — đọc file đó trước khi hỏi (không phải `.agents/product-marketing.md`, file đó không tồn tại trong vault này). Nếu `Chân Dung Doanh Nghiệp.md` còn trống, gợi ý chạy skill `mo-hinh-kinh-doanh` trước, đừng tự bịa định vị/giá trị cốt lõi.

**Lưu kết quả vào vault:** offer gắn liền với sản phẩm/gói, nên khi chốt xong offer, ghi vào `00. Business Context/Sản Phẩm & Dịch Vụ/` — cập nhật thẳng vào file gói tương ứng nếu đã có (thêm mục "Offer / Value Stack"), hoặc tạo file mới `[Tên gói] — Offer.md` nếu là gói mới. Sau khi ghi, cập nhật `_MOC Sản Phẩm & Dịch Vụ.md`. Nếu offer thay đổi giá/chính sách, ghi thêm 1 quyết định vào `Decisions/` (cần chủ DN xác nhận trước khi coi là chính thức — xem `00. Business Context/AI-Sale-Assistant.md`).
