...
| 7   | Có **test case An Nhiên Spa** (Archive) + ví dụ Spa Thảo Mộc xuyên suốt README                                                                           | Khớp ngách gốc Spa; đổi thành bản Sen Spa điền đầy là có demo sống                                                                  |
...
5. 🟠 **Điền bản Sen Spa mẫu đầy đủ** thay cho placeholder (giữ An Nhiên Spa làm bài test riêng) — để demo live mỗi buổi và làm chuẩn so sánh khi chấm bài.
